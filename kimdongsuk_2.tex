...
%Dohyeong: the functions g_2 and g_3 can be thought of as functions on the upper half plane. Equivalently, they are functions on lattices. One might want to elaborate on them (and the fundamental elliptic function mentioned above).
\newline
